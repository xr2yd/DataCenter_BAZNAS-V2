  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-200 rounded-xl overflow-hidden border border-zinc-200">
      <div className="bg-white p-4 space-y-1">
        <p className="text-[11px] font-medium text-zinc-500">Total Penyaluran ZIS 2026</p>
      ...
      <div className="bg-white p-4 space-y-1">
        ...
        <p className="text-[10px] text-emerald-700 font-medium">100% Terverifikasi Faktual</p>
      </div>
